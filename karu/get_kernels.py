...
class Kernel(object):
    ...
    def get_derivative_cov(self, X, ls):
        ...
        K_ddddx1= vmap(self.K_u.DDDD_x1_kappa, (0, 0, None))(X1_p1.flatten(), X2_p1.flatten(), ls[0]).reshape(num_X, num_X)
        u = [K_u1, K_u2]
        u_dx1 = [K_dx1, K_u2]
        u_dx2 = [K_u1, K_dx2]
        u_ddx1 = [K_ddx1, K_u2]
        u_dddx1 = [K_dddx1, K_u2]
        u_ddddx1 = [K_ddddx1, K_u2]

        return [u, u_dx1, u_dx2, u_ddx1, u_dddx1,u_ddddx1]
